...
def parse_opt():
    ...
    parser.add_argument('--learning_rate_decay', action='store_true', help='use learning_rate_decay')
    ...
    parser.add_argument('--a_feature_size', type=int, default=2048)
    parser.add_argument('--m_feature_size', type=int, default=2048)
    ...
    # Dataset settings
    parser.add_argument('--msrvtt_video_root', type=str, default='data')
    parser.add_argument('--msrvtt_anno_trainval_path', type=str, default='data/MSRVTT/train_val_videodatainfo.json')
    parser.add_argument('--msrvtt_anno_test_path', type=str, default='data/MSRVTT/test_videodatainfo.json')
    parser.add_argument('--msrvtt_anno_json_path', type=str, default='data/MSRVTT/RMN/datainfo.json')
    ...
    parser.add_argument('--msrvtt_caption_train', type=str, default='data/MSRVTT/train.txt')
    
    parser.add_argument('--msvd_video_root', type=str, default='data')
    ...
    parser.add_argument('--msvd_caption_train', type=str, default='data/MSVD/train.txt')

    parser.add_argument('--vatex_video_root', type=str, default='data')
    parser.add_argument('--vatex_csv_path', type=str, default='data/MSVD/video_corpus.csv')
    parser.add_argument('--vatex_video_name2id_map', type=str, default='data/MSVD/youtube_mapping.txt')
    parser.add_argument('--vatex_anno_json_path', type=str, default='data/MSVD/annotations.json')
    parser.add_argument('--vatex_train_range', type=tuple, default=(0, 25991))
    parser.add_argument('--vatex_val_range', type=tuple, default=(25991, 28991))
    parser.add_argument('--vatex_test_range', type=tuple, default=(28991, 34991))
    parser.add_argument('--vatex_caption_train', type=str, default='data/VATEX/vatex_training_v1.0.json')
    parser.add_argument('--vatex_caption_val', type=str, default='data/VATEX/vatex_validation_v1.0.json')
    parser.add_argument('--vatex_caption_test', type=str, default='data/VATEX/vatex_public_test_english_v1.1.json')
    ...
    args.train_prediction_txt_path = os.path.join(args.result_dir, args.dataset + '_train_predictions.txt')
    args.train_score_txt_path = os.path.join(args.result_dir, args.dataset + '_train_scores.txt')
    ...
    if args.dataset == 'msvd':
        ...
        args.feat_dir = 'data/MSRVTT'
    elif args.dataset == 'vatex':
        args.feat_dir = 'data/VATEX'
    else:
        raise ValueError('choose one dataset from msvd|msr-vtt|vatex')
    args.train_reference_txt_path = os.path.join(args.feat_dir, 'train.txt')
    ...
    if args.dataset == 'msvd':
        args.vocab_pkl_path = os.path.join(args.feat_dir,'vocab_refine.pkl')
    elif args.dataset == 'msr-vtt':
        args.vocab_pkl_path = os.path.join(args.feat_dir,'vocab_2.pkl')
    elif args.dataset == 'vatex':
        args.vocab_pkl_path = os.path.join(args.feat_dir,'vocab_refine.pkl')
    ...
    if args.dataset == 'msvd':
        args.region_feature_h5_path = '/mnt/hdd1/zhanghaonan/video_caption/data/MSVD/msvd_region_feature.h5'
    elif args.dataset == 'msr-vtt':
        args.region_feature_h5_path = '/mnt/hdd1/zengpengpeng/dataset/video_caption/MSVD/msvd/msvd_region_feature.h5'
    ...
    dataset = {
        ...
        'vatex': [args.vatex_video_root, args.vatex_anno_json_path,
                 args.vatex_train_range, args.vatex_val_range, args.vatex_test_range],
    ...
    env_tag = args.result_dir.split('/')[-1]
