...
class Decoder(nn.Module):
    ...
    def forward(self, frame_feats, cluster_feats, captions, teacher_forcing_ratio=1.0):
        ...
        if not infer or self.beam_size == 1:
            for i in range(self.max_words):
                ...
                word_logits, _, lang_lstm_h, lang_lstm_c = self.decode(frame_feats, cluster_feats,
    ...
    def beam_step(self, last_predictions, current_state):
        ...
        for i in range(num):
            ...
            word_logits, module_weight, lang_lstm_h, lang_lstm_c = self.decode(frame_feats, cluster_feats,
                                                                               previous_cells, att_lstm_h, lang_lstm_h,
                                                                               lang_lstm_c)
    ...
    def decode(self, frame_feats, cluster_feats, previous_cells, att_lstm_h, lang_lstm_h, lang_lstm_c):
        ...
        att_feat, weight = self.att(frame_feats, cluster_feats, att_lstm_h)
